...
public class FizzBuzzLucky {
	...
	public static int[] printFizzBuzz(int rangeStart, int rangeEnd) {
		...
		// Print the final output report
		System.out.println("fizz: " + fizzFrequency);
		System.out.println("buzz: " + buzzFrequency);
		System.out.println("fizzbuzz: " + fizzBuzzFrequency);
		System.out.println("lucky: " + luckyFrequency);
		System.out.println("integer: " + integerFrequency);
